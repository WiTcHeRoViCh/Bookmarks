...
module Webshot
  class Screenshot
    ...
    def capture(url, path, opts = {})
      ...
      rescue Capybara::Poltergeist::StatusFailError, Capybara::Poltergeist::BrowserError, Capybara::Poltergeist::DeadClient, Capybara::Poltergeist::TimeoutError, Webshot::WebshotError, Errno::EPIPE => e
